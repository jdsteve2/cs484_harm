...
double tot_time_flux_dq;
double tot_time_flux_dq_omp;
double tot_time_flux_F;
double tot_time_flux_F_omp;
double tot_time_flux_pr;
double tot_time_flux_pr_omp;
double tot_time_flux;
double tot_time_flux_omp;
#endif
